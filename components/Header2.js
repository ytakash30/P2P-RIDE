...
const Header2 = () => {
    return (
      <div className="h-80 flex justify-center items-center " style={{ backgroundImage: `url('/hero4.jpg')`, backgroundSize: 'cover' }}>
          <div className="mx-10 ">
              <h2 className="text-5xl font-bold text-white text-center mt-10" >"Moving Forward Together, Changing Lives"</h2>
              <div className="flex justify-center items-center text-bold">
                <button className="h-10 my-5 hover:cursor-pointer text-white  mr-5 text-xl">
